...
<div class="row">
    <div class="col-lg-4 col-lg-offset-1">
        <h3 class="text-info pull-left"><?= \Yii::t('app', 'Paso 2: Ajustar Datos') ?></h3>
    </div>
    <div class="col-lg-7">
        <ul class="list-inline pull-right">
            <li>
                <a class="btn btn-danger pull-left" href="<?= Url::to(['import/beneficiarios-paso1']) ?>">
                    <i class="fa fa-backward"></i><?= \Yii::t('app', 'Cancelar') ?>
                </a>
            </li>
...
if (count($data['Guardar']) < 1):
    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 alert alert-danger">
            <?= \Yii::t('app', 'No se importará ningún registro') ?>
        </div>
    </div>
<?php endif; ?>
...
<div class="row">
    <div class="col-lg-4 col-lg-offset-1">
        <?= \Yii::t('app', 'País de la importación') ?>
        <?=
        Select2::widget([
            'name' => "pais",
    ...
    <div class="col-lg-8 col-lg-offset-3">
        <ul class="nav nav-pills" id="myTabs" role="tablist">
            <li role="presentation" class="active">
                <a href="#crear" id="home-tab" role="tab" data-toggle="tab" aria-controls="home"
                   aria-expanded="true"><?= \Yii::t('app', 'Registros a Crear') ?></a>
            </li>
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade active in" role="tabpanel" id="crear" aria-labelledby="home-tab">
        <h4 class="text-info" style="padding: 20px"><?= \Yii::t('app', 'Registros a Crear') ?></h4>
        <div class="row" style="padding: 20px">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6 table-responsive">
                        <h3><?= \Yii::t('app', 'Proyectos') ?></h3>
                    ...
                    <div class="col-lg-6 table-responsive">
                        <h3><?= \Yii::t('app', 'Organizaciones') ?></h3>
                        <table class="table table-bordered">
                            <thead>
                            <tr>
                                <th><?= \Yii::t('app', 'Organización') ?></th>
                                <th><?= \Yii::t('app', 'Vincular con') ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $key = 0;
            ...
            <div class="col-lg-11 col-lg-offset-0">
                <div class="row">
                    <div class="col-lg-12 table-responsive">
                        <h3><?= \Yii::t('app', 'Datos a importar') ?></h3>
        ...
        <div class="row">
            <div class="col-lg-11 col-lg-offset-0">
                <?php if (count($data['Incorrecto']) > 0): ?>
                    <div class="row">
                        <div class="col-lg-12 table-responsive">
                            <h3><?= \Yii::t('app', 'Datos Incorrectos') ?></h3>
