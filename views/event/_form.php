...
<div id="event-form">
    ...
    <div class="row">
        <div class="col-md-4">
            <?php
            echo $form->field($model, 'implementing_organization_id')->widget(\kartik\select2\Select2::classname(), [
                        ...
                        <tbody>
                            <tr v-for="(att, index) in attendances">
                                ...
                                <td style="vertical-align: middle; padding-left: 10px;">
                                    <a tabindex="-1" target="_blank" :href="'<?= Url::to(['contact/view']) ?>?id=' + att.contact_id" v-show="att.contact_id">
                                ...
                                <td>
                                    <select class="form-control" :name="'Event[attendancesArray]['+index+'][sex]'" v-model="att.sex">
                                ...
                                <td>
                                    <input class="form-control" :name="'Event[attendancesArray]['+index+'][community]'" type="text" v-model="att.community">
                                </td>
                                <td >
                                    <?=
                                ...
                                <td>
                                    <input class="form-control" :name="'Event[attendancesArray]['+index+'][phone_personal]'" type="text" v-model="att.phone_personal">
                                </td>
                                <td>
                                    <?=
