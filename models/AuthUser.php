...
//        return static::findOne(['id' => $id, 'is_active' => self::ESTADO_ACTIVO]);
    ...
    {
        $this->countries = Json::decode($this->countries);
//        if (is_array($this->countries)) {
            $countries = [];
            foreach ((array)$this->countries as $c)
                $countries[] = (int)$c;
            $this->countries = $countries;
//        }
        $this->projects = Json::decode($this->projects);
//        if (is_array($this->projects)) {
            $projects = [];
...
//        }
    ...
    {
        $this->countries = Json::encode($this->countries);
        $this->projects = Json::encode($this->projects);
