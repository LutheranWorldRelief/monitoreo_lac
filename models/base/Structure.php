...
*
    ...
    *
            * @property \app\models\Calendar[] $calendars
...
return [
    ...
    */
    ...
    {
    return $this->hasMany(\app\models\Calendar::className(), ['structure_id' => 'id']);
    }
    ...
    */
    ...
    {
    return $this->hasMany(\app\models\Tracker::className(), ['structure_id' => 'id']);
    }
}
