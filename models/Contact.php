...
class Contact extends \app\models\base\Contact
{
    ...
    {
        return $this->hasOne(\app\models\Attendeetype::className(), ['id' => 'type_id']);
    }
    ...
    {
        return $this->hasOne(\app\models\SqlContactListPhonesGroup::className(), ['contact_id' => 'id']);
    }

    public function getEvents()
    {
        return $this->hasMany(\app\models\Event::className(), ['id' => 'event_id'])
            ->via('attendances');
    }

    public function getStructures()
    {
        return $this->hasMany(\app\models\Structure::className(), ['id' => 'structure_id'])
            ->via('events');
    }
    ...
    {
        return $this->hasOne(\app\models\ProjectContact::className(), ['contact_id' => 'id']);
    }
